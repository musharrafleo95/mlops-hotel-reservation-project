...
class ModelTraining:
    def __init__(self, train_path, test_path, model_output_path):
        ...
        logger.info("ModelTrainingclass initialized")

    def load_and_split_data(self):
        try:
            logger.info(f"Loading train data from {self.train_path} and test data from {self.test_path}")
    ...
    def run(self):
        try:
            with mlflow.start_run() as run:
                ...
                logger.info(f"Logging and training the testing data to MLflow")
